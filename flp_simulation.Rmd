...
To mimic what was done in `bias_diff.Rmd`, the Non-word condition (least skewed) has 200 trials and the Word condition varies from 10 to 200 trials in 10 trial increments.  
...
p <- ggplot(data=df.sum, aes(x=Size)) + theme_classic() +
  ...
  ggtitle(paste0("Bias of median differences")) 

p
p.md <- p

# save figure
# ggsave(filename='./figures/figure_flp_bias_diff_md.pdf',width=10,height=7) 
```
...
p <- ggplot(data=df.sum, aes(x=Size)) + theme_classic() +
  ...
  geom_hline(yintercept = 0, colour="black") +
    ...
    theme(plot.title = element_text(size=22),
        ...
        scale_y_continuous(breaks = seq(-50, 30, 10)) +
  labs(x = "Word condition sample size", y = "Bias in ms") +
  ggtitle(paste0("Bias of BC median differences")) 

p
p.md.bc <- p

# save figure
# ggsave(filename='./figures/figure_flp_bias_diff_md_bc.pdf',width=10,height=7) 
```
...
# save figure
# ggsave(filename='./figures/figure_flp_mdbias_diff_md.pdf',width=10,height=7) 
```
...
p <- ggplot(data=df.sum, aes(x=Size)) + theme_classic() +
  ...
  geom_hline(yintercept = 0, colour="black") +
    ...
    scale_y_continuous(breaks = seq(-50, 30, 10)) +
    labs(x = "Word condition sample size", y = "Bias in ms") +
  ggtitle(paste0("Bias of mean differences")) 

p
p.m <- p

# save figure
# ggsave(filename='./figures/figure_flp_bias_diff_m.pdf',width=10,height=7) 
```
...
# save figure
# ggsave(filename='./figures/figure_flp_mdbias_diff_m.pdf',width=10,height=7) 
```
...
cowplot::plot_grid(p.md, p.m, p.md.bc, NULL, p.md.md, p.m.md,
                          ...
                          align = "h")
# save figure
ggsave(filename='./figures/figure_flp_sim.pdf',width=10,height=15)
```
